...
let {carb: energy, fat: fatty, protein: meat} = object;
let result = [];
result.push(energy, fatty, meat);
return result;  
}
let food = {
  carb: "Pasta",
...
let bella = new Cat('Bella', 1, 'White');
...
let harry = new Wizard ('Harry', 22, 'FireBall');
harry.castSpell();
...
//Code Here
let phoneOne = new Phone ('Apple', 'iPhone 13MAX', '256GB', 'Green', 1000);
let phoneTwo = new Phone ('Samsung', 'oneNote', '100GB', 'Black', 800);
let phoneThree = new Phone ('Google', 'pixel 6', '120GB', 'White', 900);
/* 
...
//Code Here 
let myFirstMotorcycle = new Motorcycle(2, 'NeonGreen', 5000, 'Suzuki', true);
...
//Code Here
let myFirstBoat = new Boat(12, 'White', 1000, 'SEA-Duction', 'Yacht', false);
